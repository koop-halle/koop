...
/**
 * Class LostPasswordQrCodeExtension
 *
 * @package Application\Twig\Extension
 */
class LostPasswordQrCodeExtension extends \Twig\Extension\AbstractExtension
{
    /**
        ...
        return [
            new \Twig\TwigFunction(
                ...
                function (\Twig\Environment $environment, array $foo, \Application\Doctrine\Model\Player $player) {
                    ...
                    $text = \Application\Util\DependencyContainer::getInstance()->getConfiguration()->getApplicationUrl() . \Application\Router::buildLostPasswordStepTwo() . '?token=' . $player->getPasswordResetToken() . '&email=' . $player->getEmail();
                    $qrCode->setText($text);
                    $qrCode->setSize(300);
